...
- Data Load: Options -> Data Load -> Deslect "Update or delete relationships when refreshing data" and "Autodetect new relationships after data is loaded". This is so we manually do the work to understand what is going on for learning purposes.
- Regional Settings: Options -> Regional Settings -> English (United States). This is because the dates are in USA formation (Month-Day-Year). If you select other regions, you may encounter errors.
